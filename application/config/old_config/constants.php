...
//define('ADMIN_PATH', 'http://localhost/faber_launge_accounting_new_development/');

// define('SITE_PATH', 'http://localhost/faber_launge_accounting_new_development/');
// // define('SITE_PATH', $config['base_url']);
// define('ADMIN_LAYOUTS_PATH', $root.'assets/application/');
// define('ADMIN_CSS_PATH',$root.'assets/css/');
// define('ADMIN_FONT_PATH', $root.'assets/fonts/');
// define('ADMIN_JS_PATH',$root.'assets/js/');
// define('ADMIN_IMAGES_PATH',$root.'assets/images/');
// define('ADMIN_PAGES_PATH',$root.'assets/css/pages/');
// define('ADMIN_PLUGINS_PATH',$root.'assets/plugins/');
// define('DEFAULT_IMAGE',$root.'assets/application/default/default.png');
// define('COMMON_IMAGES_PATH',$root.'assets/application/images/common/');
...
// define('AWS_BUCKET_ACCESS_KEY', 'XYZ'); //it will start with A and all letters will be in capital letter ex. AKIAIW3CXXXXXRKRHR5Q it will contain 20 characters
// define('AWS_BUCKET_SECRET_KEY', 'xy123x/abc'); //this is the secrate key,this format will be like this xy123x/abc this will be a long string. 