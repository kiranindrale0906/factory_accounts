...
<?php } ?>
  <form class="fields-group-sm" action="<?=ADMIN_PATH."registers/rate_cut_booking_weight_registers/index"?>">
    <div class="row">
...
<div class="table-responsive m-t-20">
  ...
  <?php 
    ...
    if(!empty($rate_cut_booking_weight_registers))
      $this->load->view('registers/rate_cut_booking_weight_registers/table_body');
    else 
      $this->load->view('registers/rate_cut_booking_weight_registers/no_records');
