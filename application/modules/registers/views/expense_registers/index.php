...
<?php } ?>
  <form class="fields-group-sm" action="<?=ADMIN_PATH."registers/expense_registers/index"?>">
    <div class="row">
      ...
      <?php load_field('date',array('field' => 'start_date','class' => 'datepicker_js start_date', 'col'=>'col-sm-4',
                                    'value'=>date('d-m-Y',strtotime($start_date))));?>
      <?php load_field('date',array('field' => 'end_date','class' => 'datepicker_js end_date', 'col'=>'col-sm-4',
...
<div class="table-responsive m-t-20">
  ...
  <?php 
    $this->load->view('registers/expense_registers/table_header');
    if(!empty($expense_registers))
      $this->load->view('registers/expense_registers/table_body');
    else 
      $this->load->view('registers/expense_registers/no_records');
  ?>
  </table>
</div>
