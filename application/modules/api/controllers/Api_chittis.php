...
class Api_chittis extends Chittis {
  ...
  public function index() {
    if (   !empty($_POST['access_token']) 
      ...
      $chitti_details['chitti_details'] = $this->voucher_model->get('sum(fine) as fine,sum(rate) as rate,sum(factory_fine) as factory_fine,sum(credit_weight) as credit_weight,group_concat(DISTINCT(narration)) as narration,purity,chitti_purity,factory_purity,customer_name,group_concat(DISTINCT(item_code)) as item_code',
