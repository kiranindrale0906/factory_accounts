...
function getTableSettings() {
  return array(
    'page_title'          => 'ALL Period',
    'primary_table'       => 'periods',
    'default_column'      => 'id',
    'table'               => 'periods',
    'join_columns'        => '',
    'join_type'           => '',
...
function list_settings() {
  return array(
    ...
    array("Date From", "date_from", TRUE, "date_from", TRUE, TRUE),
    array("Date To", "date_to", TRUE, "date_to", TRUE, TRUE),
