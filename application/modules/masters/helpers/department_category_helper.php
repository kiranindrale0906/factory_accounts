...
function getTableSettings() {
  return array(
    'page_title'          => 'ALL DEPARTMENT CATEGORIES',
    'primary_table'       => 'ac_department_category',
    'default_column'      => 'id',
    'table'               => 'ac_department_category',
    'join_columns'        => '',
    'join_type'           => '',
    'where'               => '',
    'where_ids'           => '',
    ...
    'search_url'          => 'department_category',
    'add_title'           => 'Add Department Category',
    'export_title'        => '',
    'edit'                => '',
  );
}
...
function list_settings() {
  return array(
    ...
    array("Melting", "melting", TRUE, "melting", TRUE, TRUE),
...
function get_field_attribute($table, $field) {
  ...
  $attributes['department_category'] = array(
    'id'                      => array('', '', TRUE, '', TRUE),
    'name'                    => array('Category Name', 'Enter Category Name.', TRUE, '', TRUE),
...
function get_row_actions($row, $url, $select_url, $filter) {
  $actions = array();
  $controller = 'masters/department_category';
