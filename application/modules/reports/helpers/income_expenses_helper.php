...
function getTableSettings($table_setting_arg=array()) {
  $table_setting= array('page_title'          => 'Income Expense Reports',
...
function get_field_attribute($table, $field) {
  $ci=&get_instance();
  $attributes = array();
  $attributes['income_expenses'] = array(
    ...
    'end_date'   =>array('End date', 'Select end date', TRUE, '', TRUE));
