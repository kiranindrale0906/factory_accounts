        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center font-weight-bold" colspan="2">
              <?=sprintf('%0.2f', $opening_balance['amount_balance']-($total_credit_amt-$total_debit_amt)); ?>    
            </td>
            <td class="text-center font-weight-bold" colspan="2">
              <?=sprintf('%0.2f', $opening_balance['weight_balance']-($total_credit_weight-$total_debit_weight)); ?>    
            </td>
