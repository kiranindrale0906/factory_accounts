...
<div class="table-responsive">
  <table class="table table-sm table-default">
    ...
    ?>
      <tr>
        <td class="">AR Gold</td>
        <td class="text-right"><?=$arg_total_production?></td>
        <td class="text-right"><?=$arg_gpc_powder?></td>
        <td class="text-right"><?=$arg_gpc_vodator?></td>
        <td class="text-right"><?=$arg_unrecoverable_loss?></td>
        ...
        <td class="text-right"><?=$arg_without_recovery_per_kg_loss?></td>
      </tr><tr>
        <td class="">ARF</td>
        <td class="text-right"><?=$arf_total_production?></td>
        <td class="text-right"><?=$arf_gpc_powder?></td>
        <td class="text-right"><?=$arf_gpc_vodator?></td>
        <td class="text-right"><?=$arf_unrecoverable_loss?></td>
        ...
        <td class="text-right"><?=$arf_without_recovery_per_kg_loss?></td>
      </tr><tr>
        <td class="">ARC</td>
        <td class="text-right"><?=$arc_total_production?></td>
        <td class="text-right"><?=$arc_gpc_powder?></td>
        <td class="text-right"><?=$arc_gpc_vodator?></td>
        <td class="text-right"><?=$arc_unrecoverable_loss?></td>
        <td class="text-right"><?=$arc_final_loss=($arc_gpc_powder
                                                  +$arc_unrecoverable_loss
                                                  -$arc_gpc_vodator)?></td>
        ...
        <td class="text-right"><?=$arc_without_recovery_per_kg_loss?></td>
      </tr>
