  ...
  <div class="form-group container">
    <div class="table-responsive m-t-20">
      <table class="table table-sm fixedthead table-default">
        ...
        <tr>
          <td>Export</td>
          <td class="text-right"><?= four_decimal(-1 * $accounts_apr2023_export_balance) ?></td>
          <td class="text-right"><?= four_decimal(-1 * $live_apr2023_export_balance) ?>  </td>
          <td class="text-right"><?= four_decimal($accounts_apr2023_export_balance - $live_apr2023_export_balance) ?></td>
        </tr>

        <tr>
          <td>Domestic</td>
          <td class="text-right"><?= four_decimal(-1 * $accounts_apr2023_domestic_balance) ?></td>
          <td class="text-right"><?= four_decimal(-1 * $live_apr2023_domestic_balance) ?>  </td>
          <td class="text-right"><?= four_decimal($accounts_apr2023_domestic_balance - $live_apr2023_domestic_balance) ?></td>
        </tr>

        <tr>
          <td>Total</td>
          <td class="text-right"><?= four_decimal(-1 * (/*$accounts_aug2022_argold_balance + $accounts_aug2022_arf_balance +*/ $accounts_apr2023_arc_balance+$accounts_apr2024_argold_balance+$accounts_apr2024_arf_balance+$accounts_apr2023_export_balance+$accounts_apr2023_domestic_balance)) ?></td>
          <td class="text-right"><?= four_decimal(-1 * (/*$live_apr2024_argold_balance + $live_apr2024_arf_balance +*/ $live_apr2023_arc_balance+$live_apr2024_argold_balance+$live_apr2024_arf_balance+$live_apr2023_export_balance+$live_apr2023_domestic_balance)) ?>  </td>
          <td class="text-right"><b><?= four_decimal(-1 * (  /*$accounts_apr2024_argold_balance  - $live_apr2024_argold_balance
                                                           + $accounts_apr2024_arf_balance - $live_apr2024_arf_balance
                                                           +*/ $accounts_apr2023_arc_balance - $live_apr2023_arc_balance
                                                           +$accounts_apr2024_argold_balance - $live_apr2024_argold_balance
                                                           +$accounts_apr2024_arf_balance - $live_apr2024_arf_balance
