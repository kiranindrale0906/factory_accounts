<?php 
  ...
  $income_total = $sales_amount + ($sales_fine * $exchange_rate_diff) + ($closing_fine * ($gold_rate/10));
?>
    ...
    <div class="form-group container">
      <div class="table-responsive m-t-20">
        <table class="table table-sm fixedthead table-default">
          ...
          <tr>
            <td>Closing Stock</td>
            <td class="text-right"><?= four_decimal($closing_fine * ($gold_rate/10), '-'); ?></td>
            <td class="text-right"><?= four_decimal(($gold_rate/10), '-'); ?></td>          
