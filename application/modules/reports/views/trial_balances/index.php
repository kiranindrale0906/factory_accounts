  ...
  <div class="col-md-6">
    <div class="form-group container">
      <table class="table table-sm fixedthead table-default">
        ...
        <tr>
          <td><b>Total: </b></td>
          <td class="text-right"><b><?= four_decimal($assets_vadotar + $assets_fine + $liabilities_fine + $liabilities_vadotar, '-');  ?></b></td>
        </tr>
        <tr>
          <td><b>Closing Stock: </b></td>
          <td class="text-right"><b><?= four_decimal(-1 * ($liabilities_fine + $liabilities_vadotar + $assets_vadotar + $assets_fine), '-');  ?></b></td>
        </tr>
        <tr>
          <td><b>Balance: </b></td>
