  ...
  <div class="form-group container">
    ...
    <div class="table-responsive m-t-20">
      <table class="table table-sm fixedthead table-default">
        ...
        <tr>
          <td>Total</td>
           <td class="text-right"><?= four_decimal(($accounts_argold_alloy_vodator + $accounts_arf_alloy_vodator + $accounts_arc_alloy_vodator )) ?></td>
           <td class="text-right"><?= four_decimal(($live_argold_alloy_vodator + $live_arf_alloy_vodator + $live_arc_alloy_vodator)) ?>  </td>
