<div class="col-md-12">
  ...
  <?= getHttpButton('Generate Ledger (9 to 12)', base_url().'reports/account_ledgers/create?limit_date=5', 'float-right btn-success ml-5'); ?>
<?= getHttpButton('Generate Ledger (from current month)', base_url().'reports/account_ledgers/create?limit_date=6', 'float-right btn-success ml-5'); ?>
</div>
<?php 
