...
<div class="row"> 
  <div class="col-md-12">
    <div class="form-group container"> 
      <h5> Select Factory:
        <?php 
        $all_companies = array('AR Gold (Apr 2023)','ARF (Apr 2023)','ARC (Apr 2023)','AR Gold (Sep 2023)','ARF (Sep 2023)','ARC (Sep 2023)');
...
<div class="table-responsive">
  <table class="table table-sm table-default">
    ...
    <td class="text-right"><?=!empty($sum_loss_fine)?four_decimal($sum_recoverd_loss_fine/$sum_loss_fine*100):'-'?></td>
  </tr>
    </tbody>
  </table>
</div>
