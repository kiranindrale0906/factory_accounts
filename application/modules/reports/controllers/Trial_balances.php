...
//pd($this->data['factory_vadotar_records']);
  ...
  private function get_account_ledger_records() {
    ...
    $this->data['purchase_sales_account_domestic_export_records'] = $this->model->get($purchase_sales_account_domestic_export_with_vadotar_select, 
                                                array_merge($where, array(), 
                                                array(), array('group_by'=>'account_name, is_export'));
    
    $this->data['purchase_sales_account_domestic_export_with_vadotar_records'] = $this->model->get($purchase_sales_account_domestic_export_with_vadotar_select,array(), 
