...
class Loss_summaries extends BaseController {
  ...
  public function index() { 
    ...
    $arg_loss_records=$this->loss_details('ARG', $this->data['quator']);
    $arf_loss_records=$this->loss_details('ARF', $this->data['quator']);
    ...
    $this->data['arg_gpc_powder'] =$this->voucher_model->find('
                                                sum(credit_weight*factory_purity/100 - debit_weight*factory_purity/100) as amount',
  ...
  private function loss_details($site_name, $quator){
    $from_date = $this->data['quator']['from_date'];
    $to_date = $this->data['quator']['to_date'];
