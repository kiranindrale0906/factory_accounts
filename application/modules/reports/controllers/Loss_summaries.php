...
class Loss_summaries extends BaseController {
  ...
  public function index() { 
    ...
    $arf_vodator = $this->ledger_model->find($accounts_balance_select, array("site_name = 'AR Gold Jan 2021' AND purity != factory_purity AND account_name != 'VADOTAR'  AND ac_ledger.is_delete != 1 "=>NULL));
pd($arf_vodator);
