  ...
  public function _get_form_data() {
    ...
    foreach ($category_names as $category_name_index => $category_name_value) {
      ...
      if(isset($_GET['site_name'])&&$_GET['site_name']=='ARC'){
        ...
        $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,parent_id,0 as out_weight', array('account_name'=>'Loss Account','site_name'=>'ARC Jan 2021'),array());
        ...
        $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,parent_id,0 as out_weight', array('account_name'=>'Loss Account','site_name'=>'ARF Stagin'),array());
        $arg_jan2021_records=array_merge($jan2021_records,$ghiss_melting_loss);
        ...
        $jan2021_records=json_decode(curl_post_request($url,$data),true);
        $jan2021_records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
         $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,parent_id,0 as out_weight', array('account_name'=>'Loss Account','site_name'=>'AR Gold Jan 2021'),array());
        $arg_jan2021_records=array_merge($jan2021_records,$ghiss_melting_loss);
      }
