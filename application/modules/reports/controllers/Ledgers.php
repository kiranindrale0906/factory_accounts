  ...
  protected function get_datewise_ledger_records() {
    ...
    if ($this->data['report_type'] == 'Account Receipt Report'){
      ...
      elseif ($this->data['site_name'] == 'AR Gold (Sep 2023)'){
        ...
        $account_issue_where['account_name in ("ARF Software (Apr 2023)","ARC Software (Apr 2023)","AR Gold Software (Apr 2023)","ARF Software (Sep 2023)","ARC Software (Sep 2023)","AR Gold Software (Sep 2023)","Export Internal Software","Domestic Internal Software") '] = NULL;
      }   
    ...
    if ($this->data['domestic_export'] == 'Export') {
      ...
      if (str_contains($this->data['site_name'], 'Aug'))
        ...
        if ($this->data['site_name'] == 'ARF' || $this->data['site_name'] == 'ARF (May 2022)'|| $this->data['site_name'] == 'ARF (Apr 2023)'|| $this->data['site_name'] == 'ARF (Sep 2023)')
          $where_receipt['(narration = "ARF Software" or description = "ARF Software")'] = NULL;
        elseif ($this->data['site_name'] == 'ARC' || $this->data['site_name'] == 'ARC (May 2022)' || $this->data['site_name'] == 'ARC (Apr 2023)'|| $this->data['site_name'] == 'ARC (Sep 2023)') 
          $where_receipt['(narration = "ARC Software" or description = "ARC Software")'] = NULL;
        elseif ($this->data['site_name'] == 'AR Gold' || $this->data['site_name'] == 'AR Gold (May 2022)' || $this->data['site_name'] == 'AR Gold (Apr 2023)'|| $this->data['site_name'] == 'AR Gold (Sep 2023)')
