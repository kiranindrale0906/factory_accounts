  ...
  protected function get_datewise_ledger_records() {
    ...
    if ($this->data['report_type'] == 'Account Receipt Report'){
      ...
      if ($this->data['site_name'] == 'AR Gold (Apr 2023)'){
        ...
        $account_issue_where['account_name in ("ARF Software (Apr 2024)","ARC Software (Apr 2024)","AR Gold Software (Apr 2024)","Export Internal Software","Domestic Internal Software") '] = NULL;
      }   
...
/*    if (!empty($this->data['site_name']) && $this->data['site_name'] != 'All'){              
   ...
   // }
    ...
    if (   $this->data['report_type'] == 'Vadotar Report' || $this->data['report_type'] == 'Summary Report' || $this->data['report_type'] == 'Production Report') {
