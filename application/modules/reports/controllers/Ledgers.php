...
class Ledgers extends BaseController {
  ...
  protected function get_datewise_ledger_records() {
    ...
    if($this->data['report_type']=='Domestic Labour Ledger'){
     $receipts = $this->voucher_model->get($domestic_export_receipt_issue_select,array('account_name' => 'Domestic Labour Amount'), array(), array('order_by'=>'parent_id, voucher_type asc', 'group_by' => $this->data['group']));
