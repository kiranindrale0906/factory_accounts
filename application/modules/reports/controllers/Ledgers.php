...
class Ledgers extends BaseController {
  ...
  protected function get_datewise_ledger_records() {
    ...
    $issues   = $this->ledger_model->get($receipt_issue_select, $where_issue,   array(), array('order_by'=>'chitti_id, voucher_type, str_voucher_date asc', 'group_by' => $this->data['group']));lq();
