...
class Quator_wise_loss_reports extends BaseController {
  ...
  public function index() {
    ...
    print_r($this->data['production_total'][$quator_details['from_year'].'-'.$quator_details['from_month']]);
    pd($this->data['refresh_total'][$quator_details['from_year'].'-'.$quator_details['from_month']]);
    $this->data['work_arc']=four_decimal($this->data['production_total'][$quator_details['from_year'].'-'.$quator_details['from_month']]-$this->data['refresh_total'][$quator_details['from_year'].'-'.$quator_details['from_month']]);
    }
