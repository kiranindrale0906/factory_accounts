...
class Quator_wise_loss_reports extends BaseController {
  ...
  public function _get_form_data() {
    ...
    $categories= $this->voucher_model->get('trim(description) as description', array('account_name like "%Loss Account%"'=> null,'date(created_at)>='=>'2021-03-13'),array(),array('group_by'=>'description'));
     ...
     $data['department_names']=array_unique($category_names);
      ...
      if(!empty($data['department_names']) && !empty($this->data['quator_name'])){
        if(isset($_GET['site_name'])&&$_GET['site_name']=='ARC (May 2022)'){
          ...
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARC Loss Account (May 2022)','site_name'=>'ARC (May 2022)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
        ...
        $url=API_MAY2022_ARC_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (May 2022)','site_name'=>'ARF (May 2022)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_MAY2022_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $jan2021_records=json_decode(curl_post_request($url,$data),true);
          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'AR Gold Loss Account (May 2022)','site_name'=>'AR Gold (May 2022)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_MAY2022_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='AR Gold (Feb 2023)'){
          $ghiss_melting_loss=array();
          $url=API_FEB2023_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
          
          $jan2021_records=json_decode(curl_post_request($url,$data),true);
          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'AR Gold Loss Account (Feb 2023)','site_name'=>'AR Gold (Feb 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_FEB2023_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $jan2021_records=json_decode(curl_post_request($url,$data),true);
          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'AR Gold Loss Account (Apr 2023)','site_name'=>'AR Gold (Apr 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_APR2023_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $out_weight=!empty($ghiss_details)&&(!empty($ghiss_details['data']['ghiss_melting_out_weights']))?$ghiss_details['data']['ghiss_melting_out_weights']:0;
          $ghiss_melting_loss[$ghiss_melting_loss_index]['out_weight']=$out_weight;
          }$fire_tounch_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'AR Gold Loss Account (Apr 2023)','site_name'=>'AR Gold (Apr 2023)','receipt_type'=>'Fire Tounch Loss','quator'=>$data['quator']),array());
          ...
          $opening_loss=$this->get_opening_loss();
          $arg_records=array_merge($records,$ghiss_melting_loss,$opening_loss,$fire_tounch_loss);
          
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='AR Gold (Apr 2024)'){
          $ghiss_melting_loss=array();
          $fire_tounch_loss=array();
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='AR Gold (Sep 2023)'){
          $ghiss_melting_loss=array();
          $fire_tounch_loss=array();
          $url=API_SEP2023_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
          
          $jan2021_records=json_decode(curl_post_request($url,$data),true);
          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'AR Gold Loss Account (Sep 2023)','site_name'=>'AR Gold (Sep 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_SEP2023_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $out_weight=!empty($ghiss_details)&&(!empty($ghiss_details['data']['ghiss_melting_out_weights']))?$ghiss_details['data']['ghiss_melting_out_weights']:0;
          $ghiss_melting_loss[$ghiss_melting_loss_index]['out_weight']=$out_weight;
          }$fire_tounch_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'AR Gold Loss Account (Sep 2023)','site_name'=>'AR Gold (Sep 2023)','receipt_type'=>'Fire Tounch Loss','quator'=>$data['quator']),array());
          foreach ($fire_tounch_loss as $fire_tounch_loss_index => $fire_tounch_loss_value) {
          $data['issue_department_id']=$fire_tounch_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_SEP2023_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARC Loss Account (Aug 2022)','site_name'=>'ARC (Aug 2022)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          $opening_loss=$this->get_opening_loss();
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='ARC (Feb 2023)'){
          $ghiss_melting_loss=array();
          $url=API_FEB2023_ARC_PATH."issue_and_receipts/loss_report_for_accounts/index";
          $jan2021_records=json_decode(curl_post_request($url,$data),true);

          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARC Loss Account (Feb 2023)','site_name'=>'ARC (Feb 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          $opening_loss=$this->get_opening_loss();
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          ...
          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARC Loss Account (Apr 2023)','site_name'=>'ARC (Apr 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          $opening_loss=$this->get_opening_loss();
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          ...
          $fire_tounch_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARC Loss Account (Apr 2023)','site_name'=>'ARC (Apr 2023)','receipt_type'=>'Fire Tounch Loss','quator'=>$data['quator']),array());
          foreach ($fire_tounch_loss as $fire_tounch_loss_index => $fire_tounch_loss_value) {
          $data['issue_department_id']=$fire_tounch_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_APR2023_ARC_PATH."issue_and_receipts/loss_report_for_accounts/index";
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='ARC (Apr 2024)'){
          $ghiss_melting_loss=array();
          $fire_tounch_loss=array();
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='ARC (Sep 2023)'){
          $ghiss_melting_loss=array();
          $fire_tounch_loss=array();
          $url=API_SEP2023_ARC_PATH."issue_and_receipts/loss_report_for_accounts/index";
          $jan2021_records=json_decode(curl_post_request($url,$data),true);

          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARC Loss Account (Sep 2023)','site_name'=>'ARC (Sep 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          $opening_loss=$this->get_opening_loss();
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          ...
          $fire_tounch_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARC Loss Account (Sep 2023)','site_name'=>'ARC (Sep 2023)','receipt_type'=>'Fire Tounch Loss','quator'=>$data['quator']),array());
          foreach ($fire_tounch_loss as $fire_tounch_loss_index => $fire_tounch_loss_value) {
          $data['issue_department_id']=$fire_tounch_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_SEP2023_ARC_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (Aug 2022)','site_name'=>'ARF (Aug 2022)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_AUG2022_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='ARF (Feb 2023)'){
          $ghiss_melting_loss=array();
          $url=API_FEB2023_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
          $jan2021_records=json_decode(curl_post_request($url,$data),true);
          $records=!empty($jan2021_records)&&(!empty($jan2021_records['data']['loss_details']))?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();

          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (Feb 2023)','site_name'=>'ARF (Feb 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_FEB2023_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (Apr 2023)','site_name'=>'ARF (Apr 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
	       foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_APR2023_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $fire_tounch_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (Apr 2023)','site_name'=>'ARF (Apr 2023)','receipt_type'=>'Fire Tounch Loss','quator'=>$data['quator']),array());
          foreach ($fire_tounch_loss as $fire_tounch_loss_index => $fire_tounch_loss_value) {
          $data['issue_department_id']=$fire_tounch_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_APR2023_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
...
//pd($arg_records);
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='ARF (Apr 2024)'){
          $ghiss_melting_loss=array();
          $fire_tounch_loss=array();
          ...
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (Apr 2024)','site_name'=>'ARF (Apr 2024)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
         foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_APR2024_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
...
//pd($arg_records);
        ...
        }elseif(isset($_GET['site_name'])&&$_GET['site_name']=='ARF (Sep 2023)'){
          $ghiss_melting_loss=array();
          $fire_tounch_loss=array();
          ...
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (Sep 2023)','site_name'=>'ARF (Sep 2023)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
        foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_SEP2023_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
          ...
          $fire_tounch_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'ARF Loss Account (Sep 2023)','site_name'=>'ARF (Sep 2023)','receipt_type'=>'Fire Tounch Loss','quator'=>$data['quator']),array());
          foreach ($fire_tounch_loss as $fire_tounch_loss_index => $fire_tounch_loss_value) {
          $data['issue_department_id']=$fire_tounch_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_SEP2023_ARF_PATH."issue_and_receipts/loss_report_for_accounts/index";
...
//pd($arg_records);
          ...
          $jan2021_records=json_decode(curl_post_request($url,$data),true);
          $records=!empty($jan2021_records)?$jan2021_records['data']['loss_details']['loss_detail']:$jan2021_records['data']['loss_details']['loss_detail']=array();
          $ghiss_melting_loss=$this->voucher_model->get('description,site_name,credit_weight as in_weight,purity as in_lot_purity,argold_id as parent_id,0 as out_weight', array('account_name'=>'AR Gold Loss Account (Aug 2022)','site_name'=>'AR Gold (Aug 2022)','receipt_type'=>'Ghiss Melting Loss','quator'=>$data['quator']),array());
          foreach ($ghiss_melting_loss as $ghiss_melting_loss_index => $ghiss_melting_loss_value) {
          $data['issue_department_id']=$ghiss_melting_loss_value['parent_id'];
          $data['quator']=$this->data['quator_name'];
          $url=API_AUG2022_ARG_PATH."issue_and_receipts/loss_report_for_accounts/index";
