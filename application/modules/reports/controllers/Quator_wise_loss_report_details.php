...
class Quator_wise_loss_report_details extends Ledgers {
  ...
  private function get_loss_details() {
    ...
    $arg_jan2021_records=!empty($arg_jan2021_records)?$arg_jan2021_records['data']['loss_details']['loss_detail']:$arg_jan2021_records['data']['loss_details']['loss_detail']=array();
    ...
    $arf_jan2021_records=!empty($arf_jan2021_records)?$arf_jan2021_records['data']['loss_details']['loss_detail']:$arf_jan2021_records['data']['loss_details']['loss_detail']=array();
    ...
    $arc_jan2021_records=!empty($arc_jan2021_records)?$arc_jan2021_records['data']['loss_details']['loss_detail']:$arc_jan2021_records['data']['loss_details']['loss_detail']=array();
