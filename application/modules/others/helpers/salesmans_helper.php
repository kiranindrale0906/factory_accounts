...
function getTableSettings() {
  return array(
    'page_title'          => 'ALL Salesman',
    'primary_table'       => 'ac_salesman',
    'default_column'      => 'id',
    'table'               => 'ac_salesman',
    'join_columns'        => '',
    'join_type'           => '',
    ...
    'search_url'          => 'salesmans',
    'add_title'           => 'Add Salesman',
    'export_title'        => '',
    'edit'                => '',
  );
}
...
function list_settings() {
  return array(
    ...
    array("Salesman Code", "salesman_code", TRUE, "salesman_code", TRUE, TRUE),
