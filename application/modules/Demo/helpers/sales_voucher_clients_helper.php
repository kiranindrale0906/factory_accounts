...
function sales_voucher_clients_list_settings() {
  $list_option=array('voucher_date','created_time','voucher_number','account_name','account_id','company_id','created_time','department_name',
                     'total_gross_weight','total_net_weight','total_fine_weight','credit_amount','total_weight','custom_order','status');
...
function sales_voucher_clients_get_field_attribute($table, $field) {
  $required_fields=array('id','voucher_date','account_name','department_id','rate','account_id','purity');
