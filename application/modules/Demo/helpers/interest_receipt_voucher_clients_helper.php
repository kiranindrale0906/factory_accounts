...
function interest_receipt_voucher_clients_getTableSettings() {
  $table_setting=array('page_title'=>'Interest Receipt Voucher','where'=>'voucher_type="interest receipt voucher"');
...
function interest_receipt_voucher_clients_list_settings() {
...
function interest_receipt_voucher_clients_get_field_attribute($table, $field) {
...
function interest_receipt_voucher_clients_get_row_actions($row, $url, $select_url, $filter) {
