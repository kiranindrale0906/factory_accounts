...
function purchase_weight_receipt_voucher_clients_getTableSettings() {
  $table_setting=array('page_title'=>'Rate Cute Purchase Weight Receipt Voucher','where'=>'voucher_type="rate cute purchase weight receipt voucher"');
...
function purchase_weight_receipt_voucher_clients_list_settings() {
...
function purchase_weight_receipt_voucher_clients_get_field_attribute($table, $field) {
...
function purchase_weight_receipt_voucher_clients_get_row_actions($row, $url, $select_url, $filter) {
