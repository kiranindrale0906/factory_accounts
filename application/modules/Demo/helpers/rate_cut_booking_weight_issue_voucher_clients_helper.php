...
function rate_cut_booking_weight_issue_voucher_clients_getTableSettings() {
  $table_setting=array('page_title'=>'Rate Cut Booking Weight Issue Voucher','where'=>'voucher_type="rate cut booking weight issue voucher"');
...
function rate_cut_booking_weight_issue_voucher_clients_get_row_actions($row, $url, $select_url, $filter) {
