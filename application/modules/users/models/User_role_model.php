  ...
  public function get_controller_list($module_name='') {
    $modules = array('Masters' => array('masters/accounts','masters/groups','masters/sub_groups', 'masters/purity', 
                     ...
                     'Transactions' => array('transactions/cash_issue_vouchers', 
                                            ...
                                            'argold/packing_slips','argold/chitti_exports','argold/chitti_domestics','argold/metal_issue_chitties','argold/packing_slip_details','argold/metal_issue_packing_slips','argold/voucher_details',
                    ...
                    'SummaryReport' => array('reports/summary_reports','reports/income_expenses'),
                     'LossReport' => array(
