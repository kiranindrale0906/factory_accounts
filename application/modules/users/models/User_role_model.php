  ...
  public function get_controller_list($module_name='') {
    $modules = array('Masters' => array('masters/accounts','masters/groups','masters/sub_groups', 'masters/purity', 
                     ...
                     'Transactions' => array('transactions/cash_issue_vouchers', 
                                            ...
                                            'transactions/metal_issue_vouchers', 'transactions/metal_receipt_vouchers','transactions/metal_issue_voucher_details', 'transactions/metal_receipt_voucher_details',
                                            'transactions/sales_vouchers', 'transactions/purchase_vouchers', 'transactions/journal_vouchers',
                                            'transactions/contra_vouchers',
                                            'transactions/rate_cut_receipt_vouchers',
                                            'transactions/rate_cut_issue_vouchers',
                                            // 'transactions/rate_cut_purchase_price_issue_vouchers',
                                            // 'transactions/rate_cut_purchase_weight_issue_vouchers',
                                            // 'transactions/rate_cut_purchase_price_receipt_vouchers',
                                            // 'transactions/rate_cut_purchase_weight_receipt_vouchers',
                                            // 'transactions/rate_cut_booking_price_issue_vouchers',
                                            // 'transactions/rate_cut_booking_weight_issue_vouchers',
                                            // 'transactions/rate_cut_booking_price_receipt_vouchers',
                                            // 'transactions/rate_cut_booking_weight_receipt_vouchers',
