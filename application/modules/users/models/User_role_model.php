  ...
  public function get_controller_list($module_name='') {
    $modules = array('Masters' => array('masters/accounts','masters/groups', 'masters/purity', 
                     ...
                     'Transactions' => array('transactions/cash_issue_vouchers', 
                                            ...
                                            'transactions/purchase_price_issue_vouchers',
                                            'transactions/purchase_weight_issue_vouchers',
                                            'transactions/purchase_price_receipt_vouchers',
                                            'transactions/purchase_weight_receipt_vouchers',
