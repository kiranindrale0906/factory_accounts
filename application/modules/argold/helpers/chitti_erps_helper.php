...
function getTableSettings($data = array(), $where = array()) {
  return array(
    ...
    'search_url'          => 'chitti_erps',
    'add_title'           => 'Add Chitti erps',
    'chitti_hides'        => 'Add Chitti erps',
    'export_title'        => '',
    'edit'                => '',
...
function get_field_attribute($table, $field) {
  ...
  $attributes['chitti_erps'] = array(
    ...
    'narration'   => array('Narration', '', FALSE, '', TRUE),
    'factory_user'   => array('Factory User', 'Select', FALSE, '', TRUE),
...
function get_row_actions($row, $url, $select_url, $filter) {
  $actions = array();
  $controller = 'argold/chitti_erps';
  $module_name = 'chitti_erps';
