...
function getTableSettings() {
  return array(
    'page_title'          => 'Chalan List',
    'primary_table'       => 'chalans',
    'default_column'      => 'id',
    'table'               => 'chalans',
    'join_columns'        => '',
    'join_type'           => '',
...
function list_settings() {
  return array(
    array("Chalan No", "id", FALSE, "id", FALSE, FALSE),
...
function get_field_attribute($table, $field) {
  ...
  $attributes['chalan_details'] = array(
