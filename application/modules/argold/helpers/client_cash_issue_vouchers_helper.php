...
function list_settings() {
  $list_option=array('voucher_date','created_time', 'voucher_number', 'account_name','usd_rate','usd_credit_amount','credit_amount','taxable_amount','cgst_amount','sgst_amount','tcs_amount','description','action');
  return ac_vouchers_list_settings($list_option);
}

function get_field_attribute($table, $field) {
  $required_fields=array('id', 'voucher_date', 'account_name','credit_amount','usd_rate','usd_credit_amount','description','taxable_amount','cgst_amount','sgst_amount','tcs_amount');
