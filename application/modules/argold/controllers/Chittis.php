...
class Chittis extends BaseController {
  public function __construct() {
   ...
   public function _get_view_data() {
    ...
    $this->data['metal_voucher_details'] = $this->voucher_model->find('voucher_number,narration,account_name',array('voucher_type'=>'metal issue voucher','chitti_id'=>$this->data['record']['id']));
