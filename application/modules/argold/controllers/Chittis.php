...
class Chittis extends BaseController {
  ...
  public function _get_view_data() {
    ...
    $this->data['metal_voucher_details'] = $this->voucher_model->get('sum(fine) as fine,sum(factory_fine) as factory_fine,sum(credit_weight) as credit_weight,group_concat(narration) as narration,purity,chitti_purity,factory_purity,customer_name,credit_weight', array('voucher_type' => 'metal issue voucher',
