          ...
          <?php 
            ...
            foreach ($metal_voucher_details as $index => $metal_voucher_detail) {
              //if($packet_no == $metal_voucher_detail['packet_no']) {
                ...
                $sum_balance += $metal_voucher_detail['packing_slip_balance'];
               ...
               ?>
                ...
                <tr>
                  ...
                  <td class="text-right"><?= four_decimal($metal_voucher_detail['packing_slip_balance']); ?></td>
                  ...
                  <td class="text-right no-print"><a class='blue' href="<?=base_url().'argold/packing_slips/edit/'.$metal_voucher_detail['packing_slip_id'].'?voucher_id='.$metal_voucher_detail['id']?>">edit</a></td>
                  </tr>
                <?php $sr_no++; 
              //}
            }
