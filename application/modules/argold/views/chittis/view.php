...
<h4 style="margin-left:12%" class="heading">Chitti #<?= $record['id']; ?></h4>

<div style="max-width:40%; margin-left:12%">
...
<div style="max-width:40%; margin-left:12%; page-break-after:avoid">
  <table class="table table-sm">
    <tr>
