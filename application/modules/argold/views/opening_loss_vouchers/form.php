...
<form method="post" class="form-horizontal fields-group-sm form_radius_none" enctype="multipart/form-data"
  ...
  <div class="row">    
    ...
    <?php load_field('dropdown', array('field' => 'factory_name',
                                      'option'=>array(
                                        array('id'=>'AR Gold (Apr 2023)','name'=>'AR Gold (Apr 2023)'),array('id'=>'ARF (Apr 2023)','name'=>'ARF (Apr 2023)'),array('id'=>'ARC (Apr 2023)','name'=>'ARC (Apr 2023)'),array('id'=>'ARC (Sep 2023)','name'=>'ARC (Sep 2023)'),array('id'=>'ARC (Sep 2023)','name'=>'ARC (Sep 2023)'),array('id'=>'ARC (Sep 2023)','name'=>'ARC (Sep 2023)')))) ?>
