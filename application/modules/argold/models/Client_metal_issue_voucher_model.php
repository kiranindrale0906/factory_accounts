  ...
  public function after_save($action) {
    ...
    if (   ENABLE_API_FOR_RECEIPT 
        ...
        && (   $account_name == 'AR Gold Software (May 2022)'
            ...
            || $account_name == 'AR Gold Software (Feb 2023)'
            || $account_name == 'ARF Software (Feb 2023)'
            || $account_name == 'ARC Software (Feb 2023)'
            || $account_name == 'AR Gold Software (Apr 2023)'
            || $account_name == 'ARF Software (Apr 2023)'
            || $account_name == 'ARC Software (Apr 2023)'
            || $account_name == 'AR Gold Software (Sep 2023)'
            || $account_name == 'ARF Software (Sep 2023)'
            || $account_name == 'ARC Software (Sep 2023)'
            || $account_name == 'AR Gold Software (Apr 2024)'
            || $account_name == 'ARF Software (Apr 2024)'
            || $account_name == 'Arf Software (Aug 2024)'
            || $account_name == 'ARF Software (Aug 2024)'
            // || $account_name == 'ARC Software (Apr 2024)'
            || $account_name == 'AR Gold ERP Software'
            || $account_name == 'ARNA BANGLE'
