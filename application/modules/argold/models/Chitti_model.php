...
class Chitti_model extends BaseModel {
 ...
 public function save($after_save=true){
  ...
  public function after_save($action){
    ...
    $chitti_details=$this->voucher_model->get('',array('packet_no'=>$this->formdata['chittis']['packet_no'],'where'=>array('account_name'=>$this->attributes['account_name'],'purity'=>$this->attributes['purity'])),array());
  	foreach ($chitti_details as $index => $chitti_detail) {
