...
//pd($this->formdata);
  ...
  public function send_request_to_factory($attributes) {
    ...
    if($attributes['site_name']=="AR Gold ERP" && ($attributes['receipt_type'] == 'GPC Out' || $attributes['receipt_type'] == 'GPC' || $attributes['receipt_type'] == 'Melting Wastage' || $attributes['receipt_type'] == 'Daily Drawer Wastage'|| $attributes['receipt_type'] == 'Export Internal' || $attributes['receipt_type'] == 'Domestic Internal')){}else{
