...
class Client_metal_receipt_voucher_model extends Core_metal_receipt_voucher_model {
  ...
  public function send_request_to_factory($attributes) {
    ...
    if ($attributes['receipt_type'] == 'Metal') {
      ...
      $api_data = array_merge($api_data, array('type' => 'Pure','description' => $api_data['description'].'-'.$attributes['site_name'],'internal_wastage' => $api_data['internal_wastage']));
      $send_data['internal_receipts'] = $api_data;
      $api_url = "api/api_internal_receipts/store";
    ...
    elseif ($attributes['account_name'] == 'ARF Software Jan 2021'|| $attributes['account_name'] == 'ARF Software')
      $api_url = API_ARF_JAN2021_PATH.$api_url;
    elseif ($attributes['account_name'] == 'ARC Software Jan 2021' || $attributes['account_name'] == 'ARC Software')
