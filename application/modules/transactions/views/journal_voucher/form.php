...
<form method="post" class="form-horizontal fields-group-sm" enctype="multipart/form-data"
  ...
  ?>
    ...
    <?php load_field('date',array('field' => 'voucher_date',
                                  ...
                                  'class' => 'datepicker_js')) ?>
    <?php load_field('text', array('field' => 'from_account_name',
                                   'class'=>'autocomplete')) ?> 
    <?php load_field('text', array('field' => 'from_group_name',
                                   'class'=>'autocomplete')) ?> 
    <?php load_field('text', array('field' => 'account_name',
                                   'class'=>'autocomplete')) ?>
    <?php load_field('text', array('field' => 'to_group_name',
                                   'class'=>'autocomplete')) ?>  
    <?php load_field('hidden', array('field' => 'account_id')); ?>                               
    <?php load_field('hidden', array('field' => 'from_account_id')); ?>                               
...
<script type="text/javascript">
  ...
  var from_account_name_list='<?php echo json_encode($account_names,true);?>';
  var group_list='<?php echo json_encode($group_list,true); ?>';
  var from_group_list='<?php echo json_encode($group_list,true); ?>';
