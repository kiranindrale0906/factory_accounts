...
<div class="table-responsive">
  <table class="table table-sm table-default">
    ...
    <tbody id="table_approval_voucher">
      <?php 
        $this->load->view('transactions/approval_vouchers/subform', array('index' =>'1')); ?>
    </tbody>
  </table>
</div> 
<hr/>
  <script>
    <?php $issue_voucher_form_html = $this->load->view('transactions/approval_vouchers/subform',
