...
require_once APPPATH . "modules/".CLIENT_NAME."/models/Rate_cut_purchase_weight_issue_voucher_client_model.php";
class Rate_cut_purchase_weight_issue_voucher_model extends Rate_cut_purchase_weight_issue_voucher_client_model {
  public $router_class = "rate_cut_purchase_weight_issue_vouchers";
