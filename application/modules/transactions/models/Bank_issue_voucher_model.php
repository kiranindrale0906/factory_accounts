...
class Bank_issue_voucher_model extends BaseModel {
  ...
  public function validation_rules($klass='') {
    return array(
      array(
        'field' => 'bank_issue_voucher[voucher_date]', 
        'label' => 'Date',
        'rules' => array('trim', 'required', 
                    array('validate_voucher_date', array($this->bank_issue_voucher_model, 'check_period_exists'))),
        'errors'=>array('validate_voucher_date' => "Please set the period from master.")),
      array(
        'field' => 'bank_issue_voucher[account_name]', 
        'label' => 'Account Name',
        'rules' => 'trim|required'),
      array(
        'field' => 'bank_issue_voucher[credit_amount]', 
        'label' => 'Credit Amount',
        'rules' => 'trim|required|numeric|greater_than[0]'),
      array(
        'field' => 'bank_issue_voucher[cheque_number]', 
        'label' => 'Check Number',
        'rules' => 'trim|numeric'),
      array(
        'field' => 'bank_issue_voucher[bank_name]', 
        'label' => 'Bank Name',
        'rules' => array('trim', 'required', 
                    array('validate_bank_name', array($this->bank_issue_voucher_model, 'verify_bank_name'))),
