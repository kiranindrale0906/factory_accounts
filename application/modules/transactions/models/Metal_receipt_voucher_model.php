...
class Metal_receipt_voucher_model extends BaseModel {
  ...
  public function validation_rules($klass='') {
    return array(
      array(
        'field' => 'metal_receipt_voucher[voucher_date]', 
        'label' => 'Date',
        'rules' => array('trim', 'required', 
                    array('validate_voucher_date', array($this->metal_receipt_voucher_model, 'check_period_exists'))),
        'errors'=>array('validate_voucher_date' => "Please set the period from master.")),
      array(
        'field' => 'metal_receipt_voucher[purity]', 
        'label' => 'Purity',
        'rules' => 'trim|required|numeric|less_than_equal_to[100]'),
      array(
        'field' => 'metal_receipt_voucher[account_name]', 
        'label' => 'Account Name',
        'rules' => 'trim|required'),
      array(
        'field' => 'metal_receipt_voucher[debit_weight]', 
        'label' => 'Debit Weight',
