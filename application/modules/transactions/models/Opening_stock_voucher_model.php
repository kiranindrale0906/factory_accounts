...
if (file_exists(APPPATH . "modules/".CLIENT_NAME."/models/Client_opening_stock_voucher_model.php")) {

  require_once APPPATH . "modules/".CLIENT_NAME."/models/Client_opening_stock_voucher_model.php";  
  class Opening_stock_voucher_model extends Client_opening_stock_voucher_model {
  ...
  class Opening_stock_voucher_model extends Core_opening_stock_voucher_model {
    function __construct($data=array()) {
      parent::__construct($data);
    }
  } 
