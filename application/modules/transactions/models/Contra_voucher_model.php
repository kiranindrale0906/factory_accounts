...
class Contra_voucher_model extends BaseModel {
  ...
  public function validation_rules($klass='') {
    return array(
      array(
        'field' => 'contra_voucher[voucher_date]', 
        'label' => 'Date',
        'rules' => array('trim', 'required', 
                    array('validate_voucher_date', array($this->contra_voucher_model, 'check_period_exists'))),
        'errors'=>array('validate_voucher_date' => "Please set the period from master.")),
      array(
        'field' => 'contra_voucher[account_name]', 
        'label' => 'To Account Name',
        'rules' => 'trim|required'),
      array(
        'field' => 'contra_voucher[from_account_name]', 
        'label' => 'From Account Name',
        'rules' => 'trim|required'),
      array(
        'field' => 'contra_voucher[amount]', 
        'label' => 'Amount',
