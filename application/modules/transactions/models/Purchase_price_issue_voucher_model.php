...
require_once APPPATH . "modules/".CLIENT_NAME."/models/Purchase_price_issue_voucher_client_model.php";
class Purchase_price_issue_voucher_model extends Purchase_price_issue_voucher_client_model {
  public $router_class = "purchase_price_issue_vouchers";
