...
require_once APPPATH . "modules/".CLIENT_NAME."/models/Purchase_weight_receipt_voucher_client_model.php";
class Purchase_weight_receipt_voucher_model extends Purchase_weight_receipt_voucher_client_model {
  public $router_class = "purchase_weight_receipt_vouchers";
