...
function list_settings() {
  $list_option=array('voucher_date','created_time','voucher_number','account_name','purity','factory_purity','debit_weight','pure_gold_debit','narration','account_id','company_id','receipt_type');
...
function get_field_attribute($table, $field) {
  $required_fields=array('id','voucher_date','account_name','debit_weight','narration','vouchersamount',
                         'company_id','account_id','document','purity','factory_purity','receipt_type','type','quantity','hook_kdm_purity','fine','factory_fine','arg_weight');
