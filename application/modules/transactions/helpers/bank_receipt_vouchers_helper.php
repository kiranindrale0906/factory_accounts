...
function list_settings() {
  $list_option=array('voucher_date','voucher_number','bank_name','cheque_number','account_name','debit_amount','narration','action');
...
function get_field_attribute($table, $field) {
  $required_fields=array('id','voucher_date','account_name','debit_amount','narration','vouchersamount','bank_name','company_id','account_id','document');
