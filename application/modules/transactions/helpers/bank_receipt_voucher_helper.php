...
function getTableSettings() {
  return array(
    'page_title'          => 'All Bank Receipt Voucher',
    'primary_table'       => 'ac_vouchers',
    'default_column'      => 'id',
    'table'               => 'ac_vouchers',
    'join_columns'        => '',
    'join_type'           => '',
    'where'               => 'voucher_type="bank receipt voucher"',
    'where_ids'           => '',
    'order_by'            => '',
    'limit'               => "20",
    ...
    'search_url'          => 'bank_receipt_voucher',
    'add_title'           => '',
    'export_title'        => '',
    'edit'                => '',
...
function list_settings() {
  return array(
    ...
    array("Credit Amt.", "credit_amount", TRUE, "credit_amount", FALSE, TRUE),
...
function get_field_attribute($table, $field) {
  ...
  $attributes['bank_receipt_voucher'] = array(
    'id'              => array('', '', TRUE, '', TRUE),
    ...
    'debit_amount'    => array('Debit Amount', 'Enter Debit Amount', TRUE, '', TRUE),
...
function get_row_actions($row, $url, $select_url, $filter) {
  $actions = array();
  $controller = 'transaction/bank_receipt_voucher'; 
