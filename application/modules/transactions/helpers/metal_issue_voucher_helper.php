...
function getTableSettings() {
  return array(
    'page_title'          => 'All Metal Issue Voucher',
    ...
    'search_url'          => 'metal_issue_voucher',
    'add_title'           => '',
    'export_title'        => '',
    'edit'                => '',
...
function list_settings() {
  return array(
    ...
    array("Debit Wt.", "credit_weight", TRUE, "credit_weight", FALSE, TRUE),
    array("Purity", "purity", TRUE, "purity", FALSE, TRUE),
    array("Pure Gold", "pure_gold_credit", TRUE, "pure_gold_credit", FALSE, TRUE),
...
function get_field_attribute($table, $field) {
  ...
  $attributes['metal_issue_voucher'] = array(
    'id'              => array('', '', TRUE, '', TRUE),
    ...
    'credit_weight'   => array('Credit Weight', 'Enter Credit Weight', TRUE, '', TRUE),
...
function get_row_actions($row, $url, $select_url, $filter) {
  $actions = array();
  $controller = 'transaction/metal_issue_voucher'; 
