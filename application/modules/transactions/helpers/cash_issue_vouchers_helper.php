...
function getTableSettings() {
  $table_setting=array('page_title'=>'Cash Issue Voucher',
                      'where'=>'voucher_type="cash issue voucher" and 
...
function list_settings() {
  $list_option=array('voucher_date','voucher_number','account_name','credit_amount','narration','action');
...
function get_field_attribute($table, $field) {
  $required_fields=array('id','voucher_date','account_name','credit_amount','narration','vouchersamount',
