<?php
	function available_urls_before_login(){ 
		return array('users/login/index','users/login/create','users/login/store','masters/accounts/index','masters/quators/index',
									'users/login/update',
                  ...
                  'api/api_metal_issue_vouchers/store','api/api_chittis/index','api/api_chittis','api/api_metal_receipt_vouchers/store','api/api_cash_receipt_vouchers/store','api/api_cash_issue_vouchers/store','api/api_cash_receipt_vouchers/index','api/api_cash_issue_vouchers/index',
                   'reports/telegram_production_summary/index',
                   'reports/telegram_vodator_reports/index');
	}
