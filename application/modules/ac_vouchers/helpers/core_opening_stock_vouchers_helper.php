...
if (!function_exists('getTableSettings')) {
  function getTableSettings() {
    $table_setting=array('page_title'=>'Opening Stock Voucher', 
                         'where'=>'voucher_type="opening stock voucher"');
...
if (!function_exists('list_settings')) {
  function list_settings() {
    $list_option=array('voucher_date','created_time','voucher_number','account_name', 'debit_weight', 'credit_weight', 'purity', 'fine','action');
