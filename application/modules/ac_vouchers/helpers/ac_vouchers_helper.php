...
function ac_vouchers_getTableSettings($table_setting_arg=array()) {
  ...
  $table_setting_arg['where'] .= ' and receipt_type not in ("Alloy Vodator", "GPC Vodator", "Stone Vatav","Spring Vatav", "Meena Vatav", "Copper Vatav", "Rhodium Vatav")';
  }
  $table_setting= array('page_title'          => '',
                        ...
                        'where'               => '',
                        'where_ids'           => '',
                        'order_by'            => 'ac_vouchers.voucher_date desc, ac_vouchers.created_at desc',
                        'limit'               => "20",
...
function ac_vouchers_list_settings($list_setting_arg=array()) {
  ...
  $list_setting['erp_customer_name'] = array("Erp Customer Name", "erp_customer_name", TRUE, "erp_customer_name", TRUE, TRUE);
