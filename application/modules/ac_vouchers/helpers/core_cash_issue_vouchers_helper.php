...
if (!function_exists('list_settings')) {
  function list_settings() {
    $list_option=array('voucher_date', 'created_time', 'voucher_number', 'account_name', 'credit_amount','taxable_amount','cgst_amount','sgst_amount','tcs_amount', 'narration');
...
if (!function_exists('get_field_attribute')) {
  function get_field_attribute($table, $field) {  
    $required_fields=array('id', 'voucher_date', 'account_name', 'credit_amount','taxable_amount','cgst_amount','sgst_amount','tcs_amount', 'narration', 'account_id', 'purity');
