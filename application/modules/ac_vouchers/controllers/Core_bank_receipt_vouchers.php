...
class Core_bank_receipt_vouchers extends Vouchers {
  ...
  public function __construct() {
    ...
    if (file_exists(APPPATH . "modules/".CLIENT_NAME."/helpers/client_bank_receipt_vouchers_helper.php")) {
      $this->load->helper(CLIENT_NAME.'/client_bank_receipt_vouchers');
    }
    $this->load->helper('ac_vouchers/core_bank_receipt_vouchers');
  }
}