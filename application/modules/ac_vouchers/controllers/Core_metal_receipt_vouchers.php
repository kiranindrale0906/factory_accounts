...
class Core_metal_receipt_vouchers extends Vouchers {
  ...
  public function __construct() {
    ...
    if (file_exists(APPPATH . "modules/".CLIENT_NAME."/helpers/client_metal_receipt_vouchers_helper.php")) {
      $this->load->helper(CLIENT_NAME.'/client_metal_receipt_vouchers');
    }
    $this->load->helper('ac_vouchers/core_metal_receipt_vouchers');
  }
}