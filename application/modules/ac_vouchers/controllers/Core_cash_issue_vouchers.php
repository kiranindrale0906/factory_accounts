...
class Core_cash_issue_vouchers extends Vouchers {
  ...
  public function __construct() {
    ...
    if (file_exists(APPPATH . "modules/".CLIENT_NAME."/helpers/client_cash_issue_vouchers_helper.php")) {
      $this->load->helper(CLIENT_NAME.'/client_cash_issue_vouchers');
    }
    $this->load->helper('ac_vouchers/core_cash_issue_vouchers');
  }
}