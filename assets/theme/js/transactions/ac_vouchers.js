...
$('input[name*="rate_cut_purchase_price_issue_vouchers"').on('keyup', function() {
   calculate_rate_cut_purchase_price_issue_vouchers();
});
$('input[name*="rate_cut_purchase_weight_issue_vouchers"').on('keyup', function() {
   calculate_rate_cut_purchase_weight_issue_vouchers();
});
$('input[name*="rate_cut_purchase_price_receipt_vouchers"').on('keyup', function() {
   calculate_rate_cut_purchase_price_receipt_vouchers();
});
$('input[name*="rate_cut_purchase_weight_receipt_vouchers"').on('keyup', function() {
   calculate_rate_cut_purchase_weight_receipt_vouchers();
});$('input[name*="rate_cut_booking_price_issue_vouchers"').on('keyup', function() {
	 calculate_rate_cut_booking_price_issue_vouchers();
});
$('input[name*="rate_cut_booking_weight_issue_vouchers"').on('keyup', function() {
	 calculate_rate_cut_booking_weight_issue_vouchers();
});
$('input[name*="rate_cut_booking_price_receipt_vouchers"').on('keyup', function() {
	 calculate_rate_cut_booking_price_receipt_vouchers();
});
$('input[name*="rate_cut_booking_weight_receipt_vouchers"').on('keyup', function() {
...
function calculate_rate_cut_purchase_price_issue_vouchers() {
    ...
    var gold_rate_purity = $('input[name*="rate_cut_purchase_price_issue_vouchers[gold_rate_purity]"]').val();
    var gold_weight = $('input[name*="rate_cut_purchase_price_issue_vouchers[gold_weight]"]').val();
    var gold_weight_purity = $('input[name*="rate_cut_purchase_price_issue_vouchers[gold_weight_purity]"]').val();
    ...
    $('input[name*="rate_cut_purchase_price_issue_vouchers[debit_amount]').val(calculated_result);
}

function calculate_rate_cut_purchase_price_receipt_vouchers() {
    var gold_rate = $('input[name*="rate_cut_purchase_price_receipt_vouchers[gold_rate]"]').val();
    var gold_rate_purity = $('input[name*="rate_cut_purchase_price_receipt_vouchers[gold_rate_purity]"]').val();
    var gold_weight = $('input[name*="rate_cut_purchase_price_receipt_vouchers[gold_weight]"]').val();
    var gold_weight_purity = $('input[name*="rate_cut_purchase_price_receipt_vouchers[gold_weight_purity]"]').val();
    var calculated_result = 0;
        gold_rate = gold_rate / 10;
        var rate_pure_gold = (gold_rate / gold_rate_purity) * 100;
        var gold_weight_pure_gold = (gold_weight * gold_weight_purity) / 100;
    ...
    $('input[name*="rate_cut_purchase_price_receipt_vouchers[credit_amount]').val(calculated_result);
}

function calculate_rate_cut_purchase_weight_issue_vouchers() {
	var gold_rate = $('input[name*="rate_cut_purchase_weight_issue_vouchers[gold_rate]"]').val();
	var gold_rate_purity = $('input[name*="rate_cut_purchase_weight_issue_vouchers[gold_rate_purity]"]').val();
	var amount = $('input[name*="rate_cut_purchase_weight_issue_vouchers[amount]"]').val();
	var calculated_result = 0;
    ...
    $('input[name*="rate_cut_purchase_weight_issue_vouchers[debit_weight]').val(calculated_result);
}

function calculate_rate_cut_purchase_weight_receipt_vouchers() {
	var gold_rate = $('input[name*="rate_cut_purchase_weight_receipt_vouchers[gold_rate]"]').val();
	var gold_rate_purity = $('input[name*="rate_cut_purchase_weight_receipt_vouchers[gold_rate_purity]"]').val();
	var amount = $('input[name*="rate_cut_purchase_weight_receipt_vouchers[amount]"]').val();
	var calculated_result = 0;
	gold_weight_purity = 100.00;
    amount = amount * 100;
    gold_rate = gold_rate / 10;
    ...
    $('input[name*="rate_cut_purchase_weight_receipt_vouchers[credit_weight]').val(calculated_result);
}


function calculate_rate_cut_booking_price_issue_vouchers() {
    var gold_rate = $('input[name*="rate_cut_booking_price_issue_vouchers[gold_rate]"]').val();
    var gold_rate_purity = $('input[name*="rate_cut_booking_price_issue_vouchers[gold_rate_purity]"]').val();
    var gold_weight = $('input[name*="rate_cut_booking_price_issue_vouchers[gold_weight]"]').val();
    var gold_weight_purity = $('input[name*="rate_cut_booking_price_issue_vouchers[gold_weight_purity]"]').val();
    var calculated_result = 0;
        gold_rate = gold_rate / 10;
        var rate_pure_gold = (gold_rate / gold_rate_purity) * 100;
        var gold_weight_pure_gold = (gold_weight * gold_weight_purity) / 100;
    ...
    $('input[name*="rate_cut_booking_price_issue_vouchers[debit_amount]').val(calculated_result);
}

function calculate_rate_cut_booking_price_receipt_vouchers() {
    var gold_rate = $('input[name*="rate_cut_booking_price_receipt_vouchers[gold_rate]"]').val();
    var gold_rate_purity = $('input[name*="rate_cut_booking_price_receipt_vouchers[gold_rate_purity]"]').val();
    var gold_weight = $('input[name*="rate_cut_booking_price_receipt_vouchers[gold_weight]"]').val();
    var gold_weight_purity = $('input[name*="rate_cut_booking_price_receipt_vouchers[gold_weight_purity]"]').val();
    var calculated_result = 0;
        gold_rate = gold_rate / 10;
        var rate_pure_gold = (gold_rate / gold_rate_purity) * 100;
        var gold_weight_pure_gold = (gold_weight * gold_weight_purity) / 100;
    ...
    $('input[name*="rate_cut_booking_price_receipt_vouchers[credit_amount]').val(calculated_result);
}

function calculate_rate_cut_booking_weight_issue_vouchers() {
  var gold_rate = $('input[name*="rate_cut_booking_weight_issue_vouchers[gold_rate]"]').val();
  var gold_rate_purity = $('input[name*="rate_cut_booking_weight_issue_vouchers[gold_rate_purity]"]').val();
  var amount = $('input[name*="rate_cut_booking_weight_issue_vouchers[amount]"]').val();
  var calculated_result = 0;
  gold_weight_purity = 100.00;
    amount = amount * 100;
    gold_rate = gold_rate / 10;
    var rate_pure_gold = (gold_rate / gold_rate_purity) * 100;
    calculated_result = (amount / rate_pure_gold) / gold_weight_purity * 100;
    $('input[name*="rate_cut_booking_weight_issue_vouchers[debit_weight]').val(calculated_result);
}

function calculate_rate_cut_booking_weight_receipt_vouchers() {
  var gold_rate = $('input[name*="rate_cut_booking_weight_receipt_vouchers[gold_rate]"]').val();
  var gold_rate_purity = $('input[name*="rate_cut_booking_weight_receipt_vouchers[gold_rate_purity]"]').val();
  var amount = $('input[name*="rate_cut_booking_weight_receipt_vouchers[amount]"]').val();
  var calculated_result = 0;
  gold_weight_purity = 100.00;
    amount = amount * 100;
    gold_rate = gold_rate / 10;
    ...
    $('input[name*="rate_cut_booking_weight_receipt_vouchers[credit_weight]').val(calculated_result);
}
...
$('select[name*="chitti_erps[purity]"]').on('change', function() {
  var purity = $(this).val(); 
  var site_name = $('select[name*="chitti_erps[site_name]"] option:selected').text();
  var factory_user = $('select[name*="chitti_erps[factory_user]"] option:selected').text();
  var account =$('select[name*="chitti_erps[account_name]"] option:selected').val();  
  window.location = base_url+ 'argold/chitti_erps/create?account_name='+account+'&purity='+purity+'&site_name='+site_name+'&factory_user='+factory_user;;  
});
$('select[name*="chitti_erps[factory_user]"]').on('change', function() {
  var factory_user = $(this).val(); 
  var purity = $('select[name*="chitti_erps[purity]"] option:selected').text();
  var site_name = $('select[name*="chitti_erps[site_name]"] option:selected').text();
  var account =$('select[name*="chitti_erps[account_name]"] option:selected').val();  
  window.location = base_url+ 'argold/chitti_erps/create?account_name='+account+'&factory_user='+factory_user+'&purity='+purity.trim()+'&site_name='+site_name;  
});
$('select[name*="chalans[purity]"]').on('change', function() {
  var purity = $(this).val();
...
$('select[name*="combine_chitties[account_name]"]').on('change', function() {
  var account = $(this).val();
  var site_name =$('select[name*="combine_chitties[site_name]"] option:selected').val();  
  window.location = base_url+ 'argold/combine_chitties/create?site_name='+site_name+'&account_name='+account;  
});
...
$('select[name*="chitti_erps[site_name]"]').on('change', function() {
  var site_name = $(this).val(); 
  var purity = $('select[name*="chitti_erps[purity]"] option:selected').text();
  var account = $('select[name*="chitti_erps[account_name]"] option:selected').val();
  window.location = base_url+ 'argold/chitti_erps/create?account_name='+account+'&purity='+purity+'&site_name='+site_name;  
});
$('select[name*="chitti_exports[site_name]"]').on('change', function() {
  var site_name = $(this).val(); 
